...
/**
 * Problem:
 *  Given a string, reverse the order of words in the string without reversing
 *  the characters of the individual words.
 *  Example:
...
public class ReverseStringButNotTheCharsInWords {
    ...
    /**
     * Reverse the string without reversing the characters of individual words.
     *  Approach:
     *  -----------
     *      1. Split the string into words.
     *      2. Reverse the array of words.
